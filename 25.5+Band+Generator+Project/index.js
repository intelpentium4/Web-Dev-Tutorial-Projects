...
app.post("/submit", (req, res) => {
  ...
  const bName1 = adj[Math.floor((Math.random()*adj.length))];
  const bName2 = noun[Math.floor((Math.random()*noun.length))];
  const bName = bName1+" "+bName2;
  res.render("index.ejs", { htmlOutput: bName});
});
